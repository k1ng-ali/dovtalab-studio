...
import { useMyQuiz} from "@/features/quiz/myQuiz/store.ts";
import { storeToRefs } from "pinia"
import { onMounted, ref } from "vue"
import { useRouter } from "vue-router"

const quizStore = useMyQuiz()
  ...
  <div class="page">
    ...
    <div class="page__header">
      <div class="page__header-text">
        <h1 class="page__title">Мои викторины</h1>
        <p class="page__subtitle">все викторины созданные вами</p>
      </div>
